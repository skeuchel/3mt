...
Section Test_Section.
  ...
  Definition D := BType :+: UnitType :+: RefType.
  Definition E := Bool :+: RefE.
  Definition V := StuckValue :+: BoolValue :+: LocValue :+: UnitValue.
  ...
  Eval compute in ("Soundness for 'Bool :+: References' Proven!").
