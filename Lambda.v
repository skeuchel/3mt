...
Section Lambda.
  ...
  (* ============================================== *)
    ...
    Global Instance WF_Weaken'_Clos  :
      iPAlgebra WFValue_Weaken'_Name (WFValue_Weaken'_P ) (WFValue_Clos ).
    Proof.
      econstructor; intros.
      unfold iAlgebra; intros. apply (ind_alg_WFV_Clos ) with (P' :=
  ...
  (* ============================================== *)
    ...
    (* app case *)
       ...
       apply (WFV_proj1_a D V _ WFV _ _
         (WFV_Weaken' _ (WFV_Weaken D V _ WFV _ _ H _ H2) (insert _ t4 e0))); simpl; auto.
       generalize in_out_UP'_inverse; simpl; intros H4; apply H4.
       exact (proj2_sig _).
       destruct t4 as [t4 t4_UP'].
       eapply (WFV_Weaken' (mk_WFValue_i _ _ _ Sigma'0 _ _)); simpl; auto.
  ...
  Section Pure_Sound_X_Sec.
    ...
    Context {WFV_Weaken'_WFV : iPAlgebra WFValue_Weaken'_Name (WFValue_Weaken'_P _ WFV') WFV'}.

  Global Instance Pure_Sound_X_WFVM_Environment :
    iPAlgebra Pure_Sound_X_Name (Pure_Sound_X_P D V MT ME WFV')
    (WFValueM_Environment (TypContextCE := GammaTypContextCE _) _ WFV').
  Proof.
    econstructor.
    ...
    subst; destruct (H2 _ _ (refl_equal _) (WFV_Weaken' _ WFV' funWFV' _ WF_v_T' Sigma)
