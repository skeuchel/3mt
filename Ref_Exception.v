...
Section Ref_Exception.
  ...
  Context {Sub_ExceptE_E : ExceptE D :<: E}.
  Context {WF_Sub_ExceptE_E : WF_Functor _ _ Sub_ExceptE_E _ _}.
  ...
  Context {WF_ExceptE_Typeof_E : forall T, @WF_FAlgebra TypeofName _ _ (ExceptE D) E
    Sub_ExceptE_E (MAlgebra_typeof_ExceptE _ MT _) (Typeof_E T)}.
  Context {WF_RefE_Typeof_E : forall T, @WF_FAlgebra TypeofName _ _ RefE E
    Sub_RefE_E (MAlgebra_typeof_RefE _ MT _) (Typeof_E T)}.

  Context {evalM_E : FAlgebra EvalName (Exp E) (evalMR V ME) E}.
  Context {evalM_E' : forall T, FAlgebra EvalName T (evalMR V ME) E}.
  Context {WF_ExceptE_eval_E : @WF_FAlgebra EvalName _ _ (ExceptE D) E
    Sub_ExceptE_E (MAlgebra_evalM_ExceptE D V ME _) evalM_E}.
  Context {WF_RefE_eval_E : @WF_FAlgebra EvalName _ _ RefE E
    Sub_RefE_E (MAlgebra_evalM_RefE V ME _) evalM_E}.
