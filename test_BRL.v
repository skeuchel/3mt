...
Section Test_Section.
  ...
  Definition E (A : Set) := Bool :+: Lambda D A :+: RefE.
  ...
  Definition V := StuckValue :+: BoolValue :+: (ClosValue E) :+: LocValue :+: UnitValue.
  ...
  Eval compute in ("Type Soundness for Bool + Lambda + Ref Proven!").
