...
Section Test_Section.
  ...
  Definition E (A : Set) := Arith :+: Bool :+: Lambda D A.
  ...
  Definition V := StuckValue :+: NatValue :+: BoolValue :+: (ClosValue E).
  ...
  Definition EQV_E (A B : Set) := (Arith_eqv E A B) ::+:: (Bool_eqv E A B) ::+:: (Lambda_eqv D E A B).
  ...
  Eval compute in ("Type Soundness for Arith + Bool + Lambda Proven!").
