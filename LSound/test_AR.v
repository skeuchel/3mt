...
Section Test_Section.
  ...
  Definition D := AType :+: UnitType :+: RefType.

  Definition E := Arith :+: RefE.

  Definition V := StuckValue :+: NatValue :+: LocValue :+: UnitValue.
  ...
  Proof.
    ...
    eapply Arith_eval_soundness'' with (WFV := WFV) (WFVM := WFVM);
  ...
  Eval compute in ("Soundness for 'Arith :+: References' Proven!").
