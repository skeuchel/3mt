...
Section Test_Section.
  ...
  Definition E := Bool :+: Arith :+: ExceptE D.

  Definition V := StuckValue :+: BotValue :+: BoolValue :+: NatValue.
  ...
  Eval compute in ("Soundness for 'Arith :+: Bool :+: Exceptions' Proven!").
