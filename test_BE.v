...
Section Test_Section.
  ...
  Definition E := Bool :+: ExceptE D.

  Definition V := StuckValue :+: BotValue :+: BoolValue.
  ...
  Definition WFV := (WFValue_VB D V unit).
  ...
  Eval compute in ("Soundness for 'Bool :+: Exceptions' Proven!").
